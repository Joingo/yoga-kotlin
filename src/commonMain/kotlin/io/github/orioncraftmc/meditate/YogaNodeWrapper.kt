...
class YogaNodeWrapper private constructor(protected var mNativePointer: YGNode) : YogaNode(),
    Cloneable {
    ...
    internal constructor(config: YogaConfig) : this(GlobalMembers.YGNodeNewWithConfig((config as YogaConfigWrapper).mNativePointer)) {}
    ...
    override fun cloneWithChildren(): YogaNodeWrapper {
        return try {
            val clonedYogaNode = super.clone() as YogaNodeWrapper
    ...
    override fun cloneWithoutChildren(): YogaNodeWrapper {
        return try {
            val clonedYogaNode = super.clone() as YogaNodeWrapper
            val clonedNativePointer = GlobalMembers.YGNodeClone(mNativePointer)
            clonedYogaNode.mOwner = null
