...
class YGNode {
    ...
    fun setDirty(isDirty: Boolean) {
        if (isDirty == io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.getBooleanData(
                flags,
                isDirty_
            )
        ) {
    ...
    fun getNodeType(): YGNodeType {
        return io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.getEnumData<YGNodeType>(
            YGNodeType::class.java, flags, nodeType_
        )
    }

    fun setNodeType(nodeType: YGNodeType) {
        io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.setEnumData<YGNodeType>(
    ...
    fun print(printContext: Any?) {
        if (print_.noContext != null) {
            if (io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.getBooleanData(
                    flags,
                    printUsesContext_
                )
            ) {
    ...
    fun measure(
        ...
        return if (io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.getBooleanData(
                flags,
                measureUsesContext_
            )
    ...
    fun reset() {
        ...
        val webDefaults: Boolean =
            io.github.orioncraftmc.meditate.internal.detail.GlobalMembers.Companion.getBooleanData(
                flags,
                useWebDefaults_
            )
