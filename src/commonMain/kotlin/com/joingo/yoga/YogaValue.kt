...
data class YogaValue(val value: Float, val unit: YogaUnit) {
    ...
    companion object {
        val UNDEFINED = YogaValue(com.joingo.yoga.YogaConstants.UNDEFINED, YogaUnit.UNDEFINED)
        val ZERO: YogaValue = YogaValue(0f, YogaUnit.POINT)
        val AUTO = YogaValue(com.joingo.yoga.YogaConstants.UNDEFINED, YogaUnit.AUTO)
